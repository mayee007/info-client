pipeline {
    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                sh "/root/workspace/info-client.sh ${params.destination} ${params.artifactRepositoryUrl} ${params.mavenGroupId} ${params.mavenArtifactId} ${params.version} ${params.packaging} ${params.artifactName} ${params.artifactPath}"
            }
        }
    }
}
